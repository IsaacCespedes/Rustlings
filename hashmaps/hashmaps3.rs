...
// Learn more at https://doc.rust-lang.org/book/ch08-03-hash-maps.html#updating-a-value-based-on-the-old-value
        let mut team_1_current = scores.entry(team_1_name).or_insert(Team {
            goals_scored: 0,
            goals_conceded: 0
        });
        team_1_current.goals_scored += team_1_score;
        team_1_current.goals_conceded += team_2_score;

        let mut team_2_current = scores.entry(team_2_name).or_insert(Team {
            goals_scored: 0,
            goals_conceded: 0
        });
        team_2_current.goals_scored += team_2_score;
        team_2_current.goals_conceded += team_1_score;
